...
parser.add_argument('--datafil', type=str, default="harm_freq.gp",
        help='data file name')
parser.add_argument('--inp', type=str, default='in.3.matdyn',
        help='get kpath from ./in.3.matdyn file')
...
if ratio == 1:
    ...
    print('unit of phonon frequency not clearly specified!')
    sys.exit()
...
if ylimit:
    plt.ylim(ylimit)
plt.hlines(0,xlimit[0],xlimit[1],linestyle='dashed',color='black')

#save
plt.tight_layout()
figname= 'qe_phonon.pdf'
