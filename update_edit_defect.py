...
# modify keyword and keyvalues
# Need to enter keyword and keyvalue
# Cannot update CENTER (the defect position). Should use inter_defect_position.py which uses classA_function_defect_*.py to do it.
...
write_INFO(dictionary,pwd, incarname='SAVEINFO' )
