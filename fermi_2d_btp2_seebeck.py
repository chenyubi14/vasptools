...
if graphtype == 1:
    ...
    figname='btp2_seebeck3a_mu_low-temp.pdf'
    ...
    if dop_type == 'n':
        figname='btp2_seebeck3b_temp_n-doping.pdf'
    else:
        figname='btp2_seebeck3c_temp_p-doping.pdf'
