...
ground_omega = get_omega_from_PES(Q_ground, E_ground, ax=ax, q=q, Q0=0, dE=0) # passing ax plots lines, the fitted curve
excited_omega = get_omega_from_PES(Q_excited, E_excited, ax=ax, q=q, Q0=dQ, dE=dE) #plots the fitted curve
print('Ground: Omega=%.6f, Q0=%.6f (accurate), dE=%.6f (accurate)' % (ground_omega,0,0) )
print('Excited: Omega=%.6f, Q0=%.6f (accurate), dE=%.6f (accurate)' % (excited_omega,dQ,dE) )
...
excited_fit_func=lambda q:fitfunc(q,dQ,excited_omega,dE) # omega^2 (Q-Q0)^2/2 + dE
ground_fit_func=lambda q: fitfunc(q,0,ground_omega,0) # omega^2 Q^2/2
